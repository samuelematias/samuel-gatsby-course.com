...
const AboutPage = () => (
  <Layout>
    <SEO
      lang="en"
      title="About me"
      description="Learn a little more about the developer behind this blog."
    />
    <MainContent>
      <ButtonLink>
        <AniLink
      ...
      <p>
        ...
        <span itemProp="jobRole">Developer</span> since 2015. From 2015 to Here,
        I've worked with Test Automation, Backend and Frontend. Since         
      ...
      <p>
        ...
        doing talks and mentoring. Something that makes me very happy is knowing
        that the product I made or am making is positively impacting many
        people.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:hi@samuelematias.com">hi@samuelematias.com</a> or any of
        my social networks.
      </p>
